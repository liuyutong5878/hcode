...
/**
 * 
 * @ClassName Lunar.java
 * @Description 农历算法
 *
 * @author 1904
 * @version V1.0 
 * @Date 2014年12月24日 下午1:55:48
 */
public class Lunar {
    private int year;
    private int month;
     ...
     * @return 
     */
    public Lunar(Calendar cal, boolean isYear) {
    	this.isYear = isYear;
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Lunar lunar = new Lunar(today, true);
        System.out.println("北京时间：" + chineseDateFormat.format(today.getTime()) + "　农历" + lunar.toString());
    }
} 