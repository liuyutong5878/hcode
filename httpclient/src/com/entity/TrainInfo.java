...
/**
 * 
 * @ClassName TrainInfo.java
 * @Description 列车信息
 *
 * @author 1904
 * @version V1.0 
 * @Date 2014年12月25日 下午7:15:48
 */
public class TrainInfo implements Serializable {
	...
	private String station_train_code;  //车次编号
	private String start_station_telecode;  //始发站编码
	private String start_station_name;  //始发站
	private String end_station_telecode;  //结束站编码
	private String end_station_name;   //结束站
	private String from_station_telecode;   //搜索开始站编码
	private String from_station_name;  //搜索开始站
	private String to_station_telecode;  //搜索结束站编码
	private String to_station_name;  //搜索结束站
	private String start_time;  //出发时间
	private String arrive_time;  //到达时间
	private String day_difference;  //多少日到达
	private String train_class_name;
	private String lishi;  //历时-小时
	private String canWebBuy;  //是否可以预定 Y-可以  N-不可以
	...
	public String toString() {
		return "TrainInfo [train_no=" + train_no + ", station_train_code="
				+ station_train_code + ", start_station_telecode="
				+ start_station_telecode + ", start_station_name="
				+ start_station_name + ", end_station_telecode="
				+ end_station_telecode + ", end_station_name="
				+ end_station_name + ", from_station_telecode="
				+ from_station_telecode + ", from_station_name="
				+ from_station_name + ", to_station_telecode="
				+ to_station_telecode + ", to_station_name=" + to_station_name
				...
				+ ", is_support_card=" + is_support_card + ", yz_num=" + yz_num
				+ ", rz_num=" + rz_num + ", yw_num=" + yw_num + ", rw_num="
				+ rw_num + ", gr_num=" + gr_num + ", zy_num=" + zy_num
				+ ", ze_num=" + ze_num + ", tz_num=" + tz_num + ", gg_num="
				+ gg_num + ", yb_num=" + yb_num + ", wz_num=" + wz_num
				+ ", qt_num=" + qt_num + ", swz_num=" + swz_num
				+ ", secretStr=" + secretStr + ", buttonTextInfo="
				+ buttonTextInfo + "]";
	}
